...
exports.inMemoryCache = exports.default = void 0;
 ...
 */
class InMemoryCache extends _events.EventEmitter {
  constructor(options = {}) {
    super();
    this.cache = new Map();
...
// Singleton instance
const inMemoryCache = exports.inMemoryCache = new InMemoryCache({
  maxSize: 1000,
  defaultTTL: 0
});
